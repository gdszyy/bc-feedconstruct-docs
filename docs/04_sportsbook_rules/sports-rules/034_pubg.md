...
source_url: https://oddsfeed.feedconstruct.com/documentation?currentLoc=sports_rules&location=pubg
...
> 来源：FeedConstruct OddsFeed Documentation；抓取入口为 `https://oddsfeed.feedconstruct.com/documentation?currentLoc=sports_rules&location=pubg`。
...
PUBG matches take place in the Battle Royale mode.

Head to Head (H2H)

This Prediction wins if the specified player, pair of players, or team (four players) ranks higher than the others upon completion of the match.
