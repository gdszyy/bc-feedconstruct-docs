---
title: Selection
source_url: https://oddsfeed.feedconstruct.com/documentation?currentLoc=feedSocketApi&location=selection
...
> 来源：FeedConstruct OddsFeed Documentation；抓取入口为 `https://oddsfeed.feedconstruct.com/documentation?currentLoc=feedSocketApi&location=selection`。
...
| IsVisible\* | bool |  |
| Handicap | double |  |
| Outcome\* | int | Selection Result: • 0 - Not Resulted • 1 - Place\* • 2 - Return • 3 - Lost • 4 - Won • 5 - WinReturn • 6 - LoseReturn  **\*Note:** For Golf sport kind, if the partner doesn’t use “Each Way”, he should ignore Outcome “Place=1”, and it’s equivalent to “Lost=3” **\*Note:** The field is not available with the BetGuard service. |
